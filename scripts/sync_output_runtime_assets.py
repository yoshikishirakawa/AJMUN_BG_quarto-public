...
SAMPLE_REDIRECT_PATH = SAMPLE_OUTPUTS_DIR / "index.html"
...
SAMPLE_REDIRECT_HTML = """<!doctype html>
<html lang="ja">
<head>
  <meta charset="utf-8">
  <meta http-equiv="refresh" content="0; url=./html/index.html">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <title>AJMUN Sample Outputs</title>
</head>
<body>
  <p><a href="./html/index.html">Open the representative HTML sample</a></p>
</body>
</html>
"""
...
def sync_sample_outputs() -> int:
    ...
    SAMPLE_REDIRECT_PATH.write_text(SAMPLE_REDIRECT_HTML, encoding="utf-8")
    SAMPLE_NOJEKYLL_PATH.write_text("", encoding="utf-8")
    print(
        "[sync_output_runtime_assets] wrote: "
        f"{_display_path(SAMPLE_REDIRECT_PATH)}"
    )
    print(
        "[sync_output_runtime_assets] wrote: "
